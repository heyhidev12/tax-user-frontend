  ...
  return (
    <section className={styles['trusted-experts']}>
      <div className={styles['trusted-experts__header']}>
        <div className={styles['trusted-experts__square']}>
        </div>
            ...
            <SwiperSlide key={expert.id}>
              ...
              >
                ...
                <div className={styles['expert-card__content']}>
                  ...
                  <p className={styles['expert-card__quote']}>{expert.oneLineIntro}</p>
                  <div className={styles['expert-card__info']}>
                    <span className={styles['expert-card__name']}>{expert.name}</span>
                    {expert.workAreas && expert.workAreas.length > 0 && (
                      <>
                        <span className={styles['expert-card__divider']}>|</span>
